...
const getResType = (from, to, value) => __awaiter(void 0, void 0, void 0, function* () {
...
class QueryData {
    ...
    getInteractions() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const groupDataLove = yield getResType(this.from, this.to, 'love');
            const groupDataBookmark = yield getResType(this.from, this.to, 'bookmark');
            const groupDataRating = yield getResType(this.from, this.to, 'rating');
            return {
                groupDataView,
                groupDataLove,
                groupDataBookmark,
